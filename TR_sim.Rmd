...
pacman::p_load(tidyverse, brms, tidybayes, truncnorm, lme4, faux)
...
conditional_effects(log_lapse)
pp_check(log_lapse)
summary(log_lapse) # lapse is correctly predicted

# extract predicted values
predicted_values <- log_lapse %>%
